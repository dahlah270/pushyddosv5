...
print("\033[1;33;40m If you have any issue post a thread on https://discord.gg/cvsVwcwT66")

print("\033[1;32;40m ==> Code by Pushy <==  \n")
print("\033[1;32;40m ==> PENGGUNAAN KETIK /Python-UDP-Flood atau /Pushy <==  \n")
...
port = int(input(" Port:"))
choice = str(input(" Gasken Ngeddos Ga?(y/n):"))
